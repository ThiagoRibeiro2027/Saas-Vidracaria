...
insert into public.permissions (resource, action, description) values
  ...
  ('producao', 'apontar', 'Apontar produção/perda/retrabalho, concluir OP, reportar e encerrar manutenção corretiva (TÓPICO 4 §50, perfil Operador) — alternativa granular a producao.manage'),
  ('producao', 'planejar', 'Criar/programar/sequenciar OP, lote, lote fabril, manutenção preventiva e transferência de recurso (TÓPICO 4 §50, perfil PCP) — alternativa granular a producao.manage'),
  ('producao', 'configurar', 'Configurar roteiro, recurso, prioridade, peso de sequenciamento, horizonte e rótulo de status; cancelar OP (TÓPICO 4 §50, perfil Gestor) — alternativa granular a producao.manage'),
